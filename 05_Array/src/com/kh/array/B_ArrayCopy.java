...
public class B_ArrayCopy {
	/*
	 * 배열복사 - 얕은복사 : 배열의 주소값만을 복사. - 깊은복사 : 동일한 새로운 배열을 하나 생성하여 내부의 값들까지 복사하는 개념
	 * 
	 */
	...
	public void method4() {
		...
		int [] copy = Arrays.copyOf(origin, 10); // 복사할 개수 == 복사본 배열의 크기
	...
	public void method5() {
		...
		int[] copy = origin.clone(); // 인덱스 지정, 복사할 개수지정 X
