...
public class NetworkTest {
	...
	/*
	 * IP
	 *  - 10.10.10.10 형태로 4바이트롤 이루어진 주소값.
	...
	public void test2() {
		 ...
		 *  - 실제 URL자원에 대한 객체를 생성하여 자원엥 연결하고 데이터를 읽어올 수 있다.
		 *  
		 * URL구조
		 *  - https://kh-academy.co.kr:443/project/team.kh
		 *  
		 ...
		 *        hpprs의 기본포트 : 443, http의 기본포트 : 80, ftp의 기본포트 : 20..
		 ...
		 */
		try {
			URL url = new URL("https://kh-academy.co.kr:443/project/team.kh");
