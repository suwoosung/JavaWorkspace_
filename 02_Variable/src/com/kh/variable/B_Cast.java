...
public class B_Cast {
	 ...
	 * 
	 * 컴퓨터의 값 처리 규칙
	 * 1. 값 끼리 연산할떄는 항상 같은 자료형으로만 연산해야 한다.
	 * 		=(대입연산자)도 마찬가지로 왼쪽과 오른쪽 값이 같이 같아야함.
	 ...
	 * 
	 * 2. 강제형변환
	 * -자동형변환이 불가능한 경우, 내가 직접 형변환 연산을 사용하여 변환
	...
	public void autoCasting() {
		...
		// 		4 -> 8
		int il = 10;
		double d1 = /*(double)*/ il; // double자료형으로 형변환
