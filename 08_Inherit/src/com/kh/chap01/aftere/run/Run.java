package com.kh.chap01.aftere.run;

import com.kh.chap01.aftere.movel.vo.Desktop;
import com.kh.chap01.aftere.movel.vo.SmartPhone;
import com.kh.chap01.aftere.movel.vo.Tv;
...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 단, 자식클래스에 부모클래스에 존재하는 메서드를 재정의(오버라이딩)했다며느 자식클래스가
		 * 실행 우선권을 가진다.
		 * 
		 * 상속 장점
		 * 1. 유지보수가 편해진다.(생산성 증가)
