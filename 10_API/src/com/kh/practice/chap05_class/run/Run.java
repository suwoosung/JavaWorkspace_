package com.kh.practice.chap05_class.run;

import java.lang.reflect.Constructor;
import java.lang.reflect.Field;

import com.kh.practice.chap05_class.model.vo.Book;
...
public class Run {
	...
	public void test1() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		Class c3 = Class.forName("com.kh.practice.chap05_class.model.vo.Book");
		 ...
		 * Class클래스를 이용하여 클래스의 정보를 가져오고, 생성자가 메서드를 활용하여 객체를 생성하고, 메소드를
		 * 호출하는 방식의 프로그래밍
		 * 
		 * 보통 프로그램이 싱핼중일때, 객체의 타입을 직접 알 수 없는 경우 Class를 통해 객체를 생성하고 객체내부의
		 * 메타데이터를 수집하기위해 사용한다.
		 * 
