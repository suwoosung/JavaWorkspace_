...
public class B_Switch {
	/*
	 * switch문과 if문의 차이점 if(조건식) => 조건식을 복잡하게 기술할 수 있음. switch 은 조건식이 없으며, 확실한 값의
	 * 변수만 기술한다.
	 * 
	 ...
	 * ... default : 실행할 코드 }
	 * 
	 * switch문의 장점 - case를 통해 내가 실행하길 원하는 코드로 프리패스 하기 때문에 if~else문 보다 "훨씬 빠르"다.
	 * 
	 * switch문 - 자주 사용되지는 않지만, 정밀한 연산 결과가 "동일한 속도"로 수행되어야 하는 경우 사용한다. - ex) 키보드입력,
	 * 마우스입력
	 * 
	 */
	...
	public void method1() {
		/*
		 * 1 ~ 3사이의 정수값을 입력받아 1인 경우 빨간불 1인 경우 파란불 1인 경우 초록불 모두 아닌 경우 잘못 입력했습니다를 출력
		 */
