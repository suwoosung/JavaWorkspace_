...
public class A_IF {
	...
	public void method3() {
		/*
		 * if ~ else if문 같은 비교대상으로 "여러개의 조건을 제시해야 하는 경우 사용. if(조건식1) { // 조건식1이 true인 경우
		 * 실행할 코드 } else if(조건식2) { // 조건식2가 true인 경우 실행할 코드 } else if(조건식n) { // 조건식n가
		 * true인 경우 실행할 코드 } else { // 위 조건들이 모두 false인 경우 실행할 코드
		 */
